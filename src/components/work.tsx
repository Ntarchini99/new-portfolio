...
import PortfolioImageOne from '@/assets/uno.png'
import PortfolioImageTwo from '@/assets/dos.png'
      ...
      <div className="container mx-auto">
        <div className="flex flex-col gap-x-10 lg:flex-row">
          ...
          >
            ...
            <a href="https://cryptotrackerrrr.netlify.app/" target="_blank" rel="noopener noreferrer" className="block">
              <div className="group relative overflow-hidden rounded-xl border-2 border-white/50 cursor-pointer">
          ...
          >
            <a href="https://nursity.com.ar/" target="_blank" rel="noopener noreferrer" className="block">
              <div className="group relative overflow-hidden rounded-xl border-2 border-white/50 cursor-pointer">
                <div className="absolute z-40 h-full w-full transition-all duration-300 group-hover:bg-black/70"></div>
            ...
            <a href="https://blacklabstrategies.netlify.app/home" target="_blank" rel="noopener noreferrer" className="block">
              <div className="group relative overflow-hidden rounded-xl border-2 border-white/50 cursor-pointer">
                <div className="absolute z-40 h-full w-full transition-all duration-300 group-hover:bg-black/70"></div>
